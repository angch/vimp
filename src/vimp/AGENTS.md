...
- **Mock Header**: Use `src/vimp/mock_gtk3.h` to provide these typedefs.
...
- Use `Vimp` prefix for struct names (e.g., `VimpTool`) to comply with project naming conventions, but layout must match `Gimp` equivalents.
